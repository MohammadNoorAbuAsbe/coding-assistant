...
public static class SystemPrompt
{
 ...
 1. **Read** — Read a file. Shows content with line numbers like ""1: code"". The ENTIRE file is always returned; ""start_line""/""end_line"" are accepted for compatibility but ignored.
