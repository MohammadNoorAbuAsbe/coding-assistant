...
3. **Edit** — Edit a file by string replacement (fuzzy tolerance for leading/trailing whitespace and unicode differences, and as a last resort line-sequence similarity). CRITICAL: old_string must be copied verbatim from a Read result — never invent, guess, or reconstruct lines you did not see. Parameters: {""file_path"": ""<path>"", ""old_string"": ""<text>"", ""new_string"": ""<replacement text>""}
